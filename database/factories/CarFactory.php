...
'model_id' => function (array $attributes) {
    $model = Model::where('maker_id', $attributes['maker_id'])
                  ->inRandomOrder()
                  ->first();

    // If no model found, create a new one for the maker
    return $model ? $model->id : Model::factory()->create(['maker_id' => $attributes['maker_id']])->id;
},
            'year' => fake()->year(),
